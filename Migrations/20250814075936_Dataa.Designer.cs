...
namespace ONT_3rdyear_Project.Migrations
{
    ...
    [Migration("20250814075936_Dataa")]
    partial class Dataa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "bbdf19e1-22a2-4a92-8870-8b929d5ce64c",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEBF45mMwQRlaJeshwcAELh/gKTAVD0jigECQrCC5hKMLm/EnMnrFgoU0wYXwP+Karw==",
                        ...
                        new
                        {
                            Id = 2,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9859e6f9-ccce-4e1a-93ef-254f940d73c0",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEYyIFt4sf8G7vVZA9DoCiZDZvec+odTvOfZ1FlAs+YPg1lD13wJ7luku5WQm3YuJA==",
                            PhoneNumberConfirmed = false,
                            RoleType = "Nurse",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ONT_3rdyear_Project.Models.HospitalInfo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastUpdated = new DateTime(2025, 8, 14, 9, 59, 34, 396, DateTimeKind.Local).AddTicks(7016),
